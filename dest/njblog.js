  ...
  var t = t,
    ...
    o = function() {
      return {
        extend: function(t, e) {
          var o = function() {};
          o.prototype = e.prototype, t.prototype = new o, t.prototype.constructor = t, t.superclass = e.prototype, e.prototype.constructor == Object.prototype.constructor && (e.prototype.constructor = e)
        },
        clone: function(t) {
          var e = function() {};
          return e.prototype = t, new e
        },
        augment: function(t, e, o) {
          if (o) {
            console.log("" + o.join(","));
            for (var n = 0, r = o.length; r > n; n++) t.prototype[o[n]] = e.prototype[o[n]]
          } else
            for (var c in e.prototype) t.prototype[c] || (t.prototype[c] = e.prototype[methodname])
        },
        loadScript: function(t, o) {
          var n = e.createElement("script");
          return n.type = "text/javascript", n.readyState ? n.onreadystatechange = function() {
            ("loaded" == n.readyState || "complete" == n.readyState) && (n.onreadystatechange = null, o())
          } : n.onload = function() {
            o()
          }, n.src = t, e.getElementsByTagName("head")[0].appendChild(n), this
        },
        is_array: function(t) {
          return t && "object" == typeof t && "number" == typeof t.length && "function" == typeof t.splice && !t.propertyIsEnumerable("length")
        },
        getStyle: function(t, o) {
          var n = "float" == o ? "styleFloat" : o;
          return e.defaultView ? e.defaultView.getComputedStyle(t, null).getPropertyValue(o) : t.currentStyle[n.replace(/-[a-z]/g, function() {
            return arguments[0].charAt(1).toUpperCase()
          })]
        }
      }
    };
  t.mCore = t.m$ = o(), mCore.noConflict = function(e) {
    return t.m$ === t.mCore && (console.log("ready conflict"), t.m$ = null), e && t.mCore === mCore && (t.mCore = null), o()
  }, "function" == typeof define && define.amd && define.amd.mCore && define("mCore", [], function() {
    return o()
  })
})(window),
function(t) {
  var e = {
    preLoadImages: function(t) {
      ...
      for (var o = [], n = 0, r = function() {}, t = "object" != typeof t ? [t] : t, c = 0; t.length > c; c++) o[c] = new Image, o[c].src = t[c], o[c].onload = function() {
        e()
...
define('controllers/../../background/images', {
  imageurls: ['background/1080019485656628863.jpg_1680x10000x0x90.jpg', 'background/1285496218655438617.jpg_1680x10000x0x90.jpg',
